...
model <- lm(move_time ~ eff_trans_fid + eff_rot_fid + (1+eff_trans_fid|part_id) + (1+eff_rot_fid|part_id) + (1|part_id), data = teleop_df)
...
model <- lmer(move_time ~ eff_trans_fid * eff_rot_fid + (1+eff_trans_fid|part_id) + (1+eff_rot_fid|part_id) + (1|part_id), data = teleop_df)
summary(model)
